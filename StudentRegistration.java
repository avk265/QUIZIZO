...
// Finalize and show the frame
    ...
    private void saveToDatabase(String username, String fullName, String gender, String mobileNumber,
        ...
        String createTableSQL = "CREATE TABLE IF NOT EXISTS student_records (" +
        ...
        String insertSQL = "INSERT INTO student_records (username, full_name, gender, mobile_number, email, password, course, class, department) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mydb", "root", "kiran");
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(insertSQL)) {
                ...
                pstmt.setString(8, selectedClass);
                pstmt.setString(9, selectedDepartment);
                pstmt.executeUpdate();
            }
